...
# imgur_observations.csv may have more rows in reality, but we are only loading/previewing the first 1000 rows
df1 = pd.read_csv('/kaggle/input/imgur_observations.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'imgur_observations.csv'
nRow, nCol = df1.shape
...
nRowsRead = 1000 # specify 'None' if want to read whole file
# reddit_observations.csv may have more rows in reality, but we are only loading/previewing the first 1000 rows
df2 = pd.read_csv('/kaggle/input/reddit_observations.csv', delimiter=',', nrows = nRowsRead)
df2.dataframeName = 'reddit_observations.csv'
nRow, nCol = df2.shape
print(f'There are {nRow} rows and {nCol} columns')
...
nRowsRead = 1000 # specify 'None' if want to read whole file
# reddit_posts.csv may have more rows in reality, but we are only loading/previewing the first 1000 rows
df3 = pd.read_csv('/kaggle/input/reddit_posts.csv', delimiter=',', nrows = nRowsRead)
df3.dataframeName = 'reddit_posts.csv'
nRow, nCol = df3.shape
print(f'There are {nRow} rows and {nCol} columns')
